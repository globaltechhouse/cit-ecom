                        ...
                        <div
                            ...
                            <div class="show-case">
                                <div class="hero-slide-image">
                                    <img src="{{ asset('front/images/slider-image/slider-2-1.png') }}" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container align-self-center">
                    <div class="row">
                        ...
                        <div
                            ...
                            <div class="show-case">
                                <div class="hero-slide-image">
                                    <img src="{{ asset('front/images/slider-image/slider-2-2.png') }}" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-feature">
                    <div class="feature-icon">
                        <img src="{{ asset('front/images/icons/3.png') }}" alt="">
                    </div>
                    <div class="feature-content">
                    ...
                    <div class="nav-center">
                        <ul class="product-tab-nav nav align-items-center justify-content-center">
                            ...
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
                                    href="#tab-product--{{$category->id}}">{{ $category->name }}</a>
                                @endforeach
                        </ul>
                    </div>
                    <!-- Tab End -->
                    ...
                    <div class="tab-pane fade show active" id="tab-product--all">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="{{ route('front.product.details',[$product->slug,$product]) }}"
                                            class="image">
                                    ...
                                    <div class="content">
                                        ...
                                        <h5 class="title"><a
                                                href="{{ route('front.product.details',[$product->slug,$product]) }}">Women's
                                                Elizabeth
                                                Coat
                                            </a>
                                        </h5>
                                        <span class="price">
                                            <span
                                                class="new">{{ $product->varibales->sortBY('regular_price')->first()->regular_price }}
                                                tk.</span>
                                        </span>
                                    </div>
                                </div>
    ...
    <div class="row m-0">
        <div class="col-12 col-lg-4 mb-md-30px mb-lm-30px">
            <div class="single-banner-2">
                <img src="front/images/banner/4.jpg" alt="">
                <div class="item-disc">
        ...
        <div class="col-12 col-lg-4 center-col mb-md-30px mb-lm-30px">
            <div class="single-banner-2">
                <img src="front/images/banner/5.jpg" alt="">
                <div class="item-disc">
                    <h4 class="title">Best Collection <br>
                        For Men</h4>
                    <a href="shop-left-sidebar.html" class="shop-link btn btn-primary">Shop Now <i
        ...
        <div class="col-12 col-lg-4">
            <div class="single-banner-2">
                <img src="front/images/banner/6.jpg" alt="">
                <div class="item-disc">
                            ...
                            <div class="new-product-wrapper swiper-wrapper">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="front/images/product-image/8.jpg" alt="Product" />
                                            </a>
                                            <span class="badges">
                                                <span class="new">New</span>
                                            </span>
                                ...
                                <div class="new-product-item swiper-slide">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="front/images/product-image/9.jpg" alt="Product" />
                                            </a>
                                            <span class="badges">
                                ...
                                <div class="new-product-item swiper-slide">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="front/images/product-image/10.jpg" alt="Product" />
                                            </a>
                                            <span class="badges">
                                ...
                                <div class="new-product-item swiper-slide">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="front/images/product-image/11.jpg" alt="Product" />
                                            </a>
                                            <span class="badges">
                                ...
                                <div class="new-product-item swiper-slide">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="front/images/product-image/3.jpg" alt="Product" />
                                            </a>
                                            <span class="badges">
                                                <span class="sale">-10%</span>
                                                <span class="new">New</span>
                                ...
                                <div class="new-product-item swiper-slide">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="front/images/product-image/1.jpg" alt="Product" />
                                            </a>
                                            <span class="badges">
                                                <span class="new">New</span>
                                            </span>
...
<!-- Deal Area Start -->
<div class="deal-area deal-bg deal-bg-2" data-bg-image="front/images/deal-img/deal-bg-2.jpg">
    <div class="container ">
        <div class="row">
            <div class="col-12">
                <div class="deal-inner position-relative pt-100px pb-100px">
                    ...
                    <div class="deal-image">
                        <img class="img-fluid" src="front/images/deal-img/woman.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 mb-md-30px mb-lm-30px">
                <div class="single-blog">
                    <div class="blog-image">
                        <a href="blog-single-left-sidebar.html"><img src="front/images/blog-image/1.jpg"
            ...
            <div class="col-lg-4 mb-md-30px mb-lm-30px">
                <div class="single-blog ">
                    <div class="blog-image">
                        <a href="blog-single-left-sidebar.html"><img src="front/images/blog-image/2.jpg"
                                class="img-responsive w-100" alt=""></a>
                    </div>
                    <div class="blog-text">
                        <div class="blog-athor-date">
            ...
            <div class="col-lg-4">
                <div class="single-blog">
                    <div class="blog-image">
                        <a href="blog-single-left-sidebar.html"><img src="front/images/blog-image/3.jpg"
                                class="img-responsive w-100" alt=""></a>
                    </div>
                    <div class="blog-text">
                        <div class="blog-athor-date">
